...
IgGData[,12:31] <- as.tibble(
  residuals(lm(
    as.matrix(IgGData[,12:31])~IgGData$SEX+IgGData$AGE
    ))
  )
```
...
What proportion of variation in the glycan data is explained by the genetic data? From a biological point of view. Did you expect this? Ask around what this proportion is currently known to be from literature.
